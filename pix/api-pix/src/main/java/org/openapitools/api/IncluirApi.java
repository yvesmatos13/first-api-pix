...
@Validated
@Tag(name = "incluir", description = "the incluir API")
public interface IncluirApi {
    ...
    /**
     * POST /incluir : incluir
     * incluir chave de endereçamento
     *
     * @param incluirChaveRequest  (required)
    ...
    @RequestMapping(
        ...
        value = "/pix/api/v1/incluir",
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    
    default ResponseEntity<String> incluirPost(
        @Parameter(name = "IncluirChaveRequest", description = "", required = true) @Valid @RequestBody IncluirChaveRequest incluirChaveRequest
    ) {
