...
import org.openapitools.model.IncluirChaveRequest;
...
@Controller
@RequestMapping("${openapi.pIX.base-path:}")
public class IncluirApiController implements IncluirApi {

    private final NativeWebRequest request;

    @Autowired
    public IncluirApiController(NativeWebRequest request) {
